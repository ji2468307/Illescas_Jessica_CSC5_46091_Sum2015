...
// Function Prototypes
void compare1(char value1[][COL1], int rowA, int col1A, int row2A, int col2A, int &rightA, int &wrongA);
void compare2(char value2[][COL2], int rowB, int col2B, int row2B, int col2B, int &rightB, int &wrongB);
void compare3(char value3[][COL3], int rowC, int colC, int row2C, int col2C, int &rightC, int &wrongC);
    ...
    {   
        switch(typDif)
        {
            case 1: cout << "Type of difficulty choosen: EASY" <<endl;
                    ...
                    char card1[4][4];  // 2D array to hold the card 'X'
                    char value1[4][4]; // 2D array to hold the value assigned
                    int rowA;
                    int colA;
                    int row2A;
                    int col2A;
                    ...
                    do{
                        ...
                        compare(value1,rowA,colA,row2A,col2A,rightA,wrongA); // Compare the users choices
            ...
            case 2: cout << "Type of diffuclty choosen: MEDIUM" <<endl;
                    ...
                    char card2[5][5];  // 2D array to hold the card 'X'
                    char value2[5][5]; // 2D array to hold the value assigned
                    int rowB;
                    int colB;
                    int row2B;
                    int col2B;
            ...
            case 3: cout << "Type of difficulty choosen: HARD" <<endl;
                    ...
                    char card3[6][6];  // 2D array to hold the card 'X'
                    char value3[6][6]; // 2D array to hold the value assigned
                    int rowC;
                    int colC;
                    int row2C;
                    int col2C;
...
void compare1(char value1[][COL1], int rowA, int colA, int row2A, int col2A, int &rightA, int &wrongA)
{
...
void compare2(char value2[][COL2], int rowB, int colB, int row2B, int col2B, int &rightB, int &wrongB)
{
