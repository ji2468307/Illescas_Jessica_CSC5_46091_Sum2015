...
int main(int argc, char** argv) {
    ...
    fstream myfile;           // Create fstream data
    myfile.open("data.txt");  // Write to data.txt

    cout << "Please enter your name" << endl;
    cin >> name; //get name
    myfile << name << " " << endl; // Write name of player to myfile
    ...
    myfile << "Level of difficulty played: " << typDif << endl; // Level of 
                                                                // difficulty 
                                                                // played
...
{
    cout << "Type of difficulty chosen: EASY" <<endl;
...
{
    cout << "Type of difficulty chosen: MEDIUM" <<endl;
    ...
    cout << " the game will automatically be a GAME OVER." <<endl;
...
{
    cout << "Type of difficulty chosen: HARD" <<endl;
